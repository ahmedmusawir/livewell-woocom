			...
			<div class="col-sm-12 col-md-12 col-lg-8">
				...
				<section id="livewell-membership-orderbump">
					...
					<?php
			   		...
			   		//CHECKING FOR TARGET PRODUCT (THE MAIN PRODUCT IN THE HOME PAGE)
					...
					$product_cart_id = WC()->cart->generate_cart_id( $subscription_product_id );
		   			...
		   			$notice = 'Value of yes (1st BLOCK): ' . $yes . ' CheckBox Value: ' . $_POST['checkbox'];
				    wc_print_notice( $notice, 'notice' );


				    if(isset($_POST['checkbox']) && $_POST['checkbox'] != "")
					{
						setcookie('checked_value', $yes, time() -1);
					    echo 'checkbox is checked'; 
					    $yes = 'checked';
						setcookie('checked_value', $yes, time()+3600);
					...
					// $yes = $_COOKIE['checked_value'];


					?>  

					<h1><?php echo 'Cookie Value: ' . $_COOKIE['checked_value']; ?></h1> 

					<form action="/checkout/" method="POST" target="_self">
						<!-- <input type="checkbox" name="checkbox" value="moose" onchange="this.form.submit()" <?php echo $yes; ?> > -->
						<input type="checkbox" name="checkbox" value="moose" onchange="this.form.submit()" <?php echo $_COOKIE['checked_value']; ?> >
